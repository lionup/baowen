...
stcrreg lastftow agexp i.tedlev i.lastgrade i.lastdepress i.lastworksp i.lastchronic i.lastnchild i.lastconthm i.lastcarer if sex==1& drop1!=1&drop2!=1&drop3!=1&drop4!=1, compete(exit_typeL==2)
stcrreg lastftow agexp i.tedlev i.lastgrade i.lastdepress i.lastworksp i.lastchronic i.lastnchild i.lastconthm i.lastcarer if sex==2& drop1!=1&drop2!=1&drop3!=1&drop4!=1, compete(exit_typeL==2)
stcrreg lastwtof agexp i.tedlev i.lastgrade i.lastdepress i.lastworksp i.lastchronic i.lastnchild i.lastconthm i.lastcarer if sex==1& drop1!=1&drop2!=1&drop3!=1&drop4!=1, compete(exit_typeL==2)
stcrreg lastwtof agexp i.tedlev i.lastgrade i.lastdepress i.lastworksp i.lastchronic i.lastnchild i.lastconthm i.lastcarer if sex==2& drop1!=1&drop2!=1&drop3!=1&drop4!=1, compete(exit_typeL==2)
